...
const translations = {
    "en": {
        ...
        "card-intro-text": "I am a 21-year-old Computer Science student with strong skills in full-stack development, backend systems, and Machine Learning. I have 3 months of internship experience specifically focused on database management, and I have extensive experience building modern web applications on my own using HTML, CSS, JavaScript, Spring Boot, .NET, and PHP, along with database design and system architecture.<br><br>I am currently a contributor to the Vezilka project, an AI-driven initiative focused on the Macedonian market. The project aims to simplify and improve workflows across multiple sectors by leveraging artificial intelligence and Macedonian language data. Through this experience, I have worked with dataset preparation, data processing, and AI-related development.<br><br>I have developed several real-world applications, including an Interview Management System built with .NET, a CyberSecurity platform using PHP and MySQL, a WordPress web-application for the Museum of the Macedonian Struggle, and an Air Pollution monitoring system.<br><br>I am passionate about building efficient, scalable software and continuously expanding my knowledge in modern software development and artificial intelligence.",        "card-tech-title": "TECH STACK",
    ...
    "mk": {
        ...
        "card-intro-text": "Јас сум 21-годишен студент на компјутерски науки со силни вештини во full-stack development, backend системи и Machine Learning. Имам 3 месеци искуство на пракса каде работев исклучиво со бази на податоци, а самостојно работам на градење модерни веб апликации користејќи HTML, CSS, JavaScript, Spring Boot, .NET и PHP, заедно со дизајн на бази на податоци и системска архитектура.<br><br>Моментално работам на проектот „Везилка“, иницијатива водена од вештачка интелигенција (AI) фокусирана на македонскиот пазар. Проектот има за цел да ги поедностави и подобри работните процеси во повеќе сектори преку користење на AI и податоци на македонски јазик. Преку ова искуство, работев на подготовка на сетови со податоци, обработка на податоци и развој поврзан со вештачка интелигенција.<br><br>Имам развиено неколку реални апликации, вклучувајќи Систем за менаџирање на интервјуа (IMS) изграден со .NET, CyberSecurity платформа со PHP и MySQL, WordPress веб апликација за Музејот на македонската борба, како и систем за мониторинг на аерозагадувањето.<br><br>Амбизиоцен сум за градење ефикасен, скалабилен софтвер и континуирано проширување на моето знаење во модерниот софтверски развој и вештачката интелигенција.",        "card-tech-title": "TECH STACK",
